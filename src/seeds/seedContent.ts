...
async function seed() {
  ...
  const allRichContent = { ...richContent, ...richContent2, ...richContent3, ...richContent4, ...richContent5, ...richContent6, ...richContent7, ...richContent8, ...richContent9, ...richContent10 }
